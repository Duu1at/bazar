      ...
      listener: (context, state) {
        if (state.status.isSuccess) {
          ...
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(
              SnackBar(content: Text('Autentication failed')),
            );
        }
      },
    ...
    return Padding(
      ...
      child: RichText(
        ...
        text: TextSpan(
          children: <TextSpan>[
            TextSpan(
              text: 'loginWithEmailTermsAndPrivacyPolicyText',
...
class _NextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppButton.transparentDarkAqua(
      ...
      onPressed: state.valid ? () => context.read<LoginBloc>().add(SendEmailLinkSubmitted()) : null,
